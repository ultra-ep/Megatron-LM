...
def _add_moe_args(parser):
    ...
    # Experimental UltraEP arguments
    group.add_argument('--moe-enable-ultraep', action='store_true',
                       help='Enable UltraEP with redundant experts for real-time load balancing. '
